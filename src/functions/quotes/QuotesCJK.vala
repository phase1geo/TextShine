...
public class QuotesCJK : TextFunction {
  ...
  public override string transform_text( string original, int cursor_pos ) {
    ...
    var str = substitute_straight_quotes( original, false );

    str = str.replace( right_angled_dquote, right_cjk_dquote );
    str = str.replace( left_angled_dquote, left_cjk_dquote );
